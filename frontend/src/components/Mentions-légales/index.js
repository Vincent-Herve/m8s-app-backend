...
const Notice = () => (
  <NoticeStyled>
    ...
    numérique, dite L.C.E.N., il est porté à la connaissance des Utilisateurs du site http://localhost:8080/ les présentes mentions
    légales.
    ...
    <p>L’édition et la direction de la publication du site http://localhost:8080/ est assurée par Franck Dounry, domiciliée 17 rue joseph
saint andré et l'adresse e-mail franckd2009@hotmail.fr.</p>

    <h2>ARTICLE 2 : L’HÉBERGEUR</h2>

    <p>L'hébergeur du site http://localhost:8080/ est la Société AWS, dont le siège social est situé Californie.</p>
    ...
    En cas de modification, interruption ou suspension des services le site http://localhost:8080/ ne saurait être tenu responsable.
</p>
...
sein de son logiciel de navigation.</p>
    ...
    <p>Toute utilisation, reproduction, diffusion, commercialisation, modification de toute ou partie du sitehttp://localhost:8080/, sans
